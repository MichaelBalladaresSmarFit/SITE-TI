...
<main>
        ...
        <section id="hero" class="hero-fullscreen parallax" data-overlay-dark="7">
            <div class="background-image">
                <img src="img/backgrounds/bg-smartfit-1.jpg" alt="#">
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="hero-content-slider mt20" data-autoplay="true" data-speed="4000">
                        ...
                        <div>
                            <h1>Grupo SmartFit<br><strong>Tecnologia e Innovación</strong></h1>
                            <p class="lead">Accede a recursos, herramientas y soporte técnico para tu trabajo diario. Manuales, guías, accesos, formularios y más en un solo lugar</p>
                            <a href="#about" class="btn btn-lg btn-primary btn-scroll">Empezar</a>
                        </div>

                        <div>
                            <h1>Tecnologia e Innovación<br><strong>Grupo SmartFit</strong></h1>
                             <p class="lead">Accede a recursos, herramientas y soporte técnico para tu trabajo diario. Manuales, guías, accesos, formularios y más en un solo lugar</p>
                            <a href="#" class="btn btn-lg btn-primary btn-scroll">Empezar</a>
                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-4 counter">
                        <h1 class="bold">+</h1>
                        <h1 class="bold" data-count="400"></h1>
                        <h5>+ Tickets atendidos</h5>
                    </div>
                    <div class="col-sm-4 counter">
                        <h1 class="bold" data-count="4.94">/5</h1>
                        <h5>NPS Promedio</h5>
                    </div>
                    <div class="col-sm-4 counter">
                        <h1 class="bold">+</h1>
                        <h1 class="bold" data-count="300"></h1>
                        <h5>+ Tickets Evaluados</h5>
                    </div>
        ...
        <section class="vossen-map">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2402.5302269475674!2d-77.0299348975033!3d-12.116461197643876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c816d742d787%3A0x6c12c8fdd0b820b7!2sCompu%20Palace!5e1!3m2!1ses-419!2spe!4v1752252018538!5m2!1ses-419!2spe" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </section>
        <!-- End Map -->
</main>
